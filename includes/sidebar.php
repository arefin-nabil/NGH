...
<aside class="sidebar">
    <div class="sidebar-header">
        ...
        <div>
            <div class="sidebar-brand-title"><?= SHOP_NAME ?></div>
            <div class="sidebar-brand-subtitle">Fashion POS</div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="sales-history.php" class="nav-item <?= $currentPage === 'sales-history.php' ? 'active' : '' ?>">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
            <span>Sales History</span>
        </a>

        <div class="nav-section-title">Inventory & Catalog</div>
        ...
        <a href="barcode-generator.php" class="nav-item <?= $currentPage === 'barcode-generator.php' ? 'active' : '' ?>">
        ...
        <a href="suppliers.php" class="nav-item <?= $currentPage === 'suppliers.php' ? 'active' : '' ?>">
            ...
            <span>Suppliers Traceability</span>
        </a>
    ...
    <div class="sidebar-footer">
        <div class="user-profile-badge">
            ...
            <div class="user-info">
                ...
                <div class="user-role"><?= htmlspecialchars($_SESSION['user_email'] ?? '') ?></div>
            </div>
            <a href="profile.php" title="Profile Settings" style="color: var(--text-muted); margin-left: 0.5rem;">
            ...
            <a href="api/auth.php?action=logout" title="Logout" style="color: var(--accent-rose); margin-left: 0.5rem;">
